...
public class ToolSQL_Task  extends BaseApmosys{
...
//		Modal Dialogs
  ...
  public static void Nested_Frames(JavascriptExecutor js) throws Exception {
	  Thread.sleep(1000);
...
//		act.sendKeys("Maths").build().perform();
	...
	ScrollDown(300);
		Thread.sleep(9000);
		fluentWait(By.xpath("/html/body/div[2]/div/div/div[2]/div[1]/div/div/div[1]/div/ul/li[9]/span"));
//		driver.findElement(By.xpath("//button[coँntains(text(),'Will enable 5 seconds')]")).click();
		System.out.println("Will enable 5 seconds");
		fluentWait(By.xpath("//button[contains(text(),'Color Change')]"));
...
//		System.out.println("Dynamic Link  Operation Done");
	...
	public static void Text_Box() throws Exception {
		// TODO Auto-generated method stub
//		Thread.sleep(9900);
